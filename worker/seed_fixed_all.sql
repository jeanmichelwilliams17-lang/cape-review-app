...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2024, 'May', 4, NULL, NULL,
        ...
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 4
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2024, 'May', 9, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 9
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 11
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 21
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2024, 'May', 22, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2024, 'May', 23, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 23
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2024, 'May', 28, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 28
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 29
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2024, 'May', 32, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 32
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2025, 'May', 1, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 1
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2025, 'May', 6, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 6
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 7
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 10
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 18
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2025, 'May', 20, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2025, 'May', 22, NULL, NULL,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 24
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2025, 'May', 35, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 35
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2025, 'May', 39, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 1 AND q.number = 39
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2026, 'May', 4, NULL, NULL,
            '\text{The modulus of the complex number } ( 6 + 3i ) \text{ is}', '\text{The modulus of the complex number } ( 6 + 3i ) \text{ is}', 'LaTeX("The modulus of the complex number $( 6 + 3i )$ is").parsingMode(.onlyEquations)', 'LaTeX("The modulus of the complex number $( 6 + 3i )$ is").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2026, 'May', 9, NULL, NULL,
            '( \int \frac{1}{1+9x^2} dx ) \text{ is}', '( \int \frac{1}{1+9x^2} dx ) \text{ is}', 'LaTeX("$( \\int \\frac{1}{1+9x^2} dx )$ is").parsingMode(.onlyEquations)', 'LaTeX("$( \\int \\frac{1}{1+9x^2} dx )$ is").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2026, 'May', 21, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2026, 'May', 22, NULL, NULL,
            '\text{Which of the following series are arithmetic series?}
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2026, 'May', 45, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2020, 'May', 15, NULL, NULL,
...
What is the balance on the current account?}', 'LaTeX("Item 15 refers to the following table which shows data from the balance of payments figures of a Caribbean territory.\n\nWhat is the balance on the current account?").parsingMode(.onlyEquations)', 'LaTeX("Item 15 refers to the following table which shows data from the balance of payments figures of a Caribbean territory.\n\nWhat is the balance on the current account?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Economics U2' AND q.paper = 1 AND q.number = 15
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 15, NULL, NULL,
            '\text{Item 15 refers to the following table which shows data from the balance of payments figures of a Caribbean territory.
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2024, 'May', 42, NULL, NULL,
...
\text{The internal rate of return is}', 'LaTeX("An investment costs  $\\$1000$  and generates cash flow of  $\\$80$  over an indefinite period.\nThe internal rate of return is").parsingMode(.onlyEquations)', 'LaTeX("An investment costs  $\\$1000$  and generates cash flow of  $\\$80$  over an indefinite period.\nThe internal rate of return is").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'MOB U1' AND q.paper = 1 AND q.number = 42
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'AppliedMathematics U1' AND q.paper = 1 AND q.number = 19
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 1
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 3, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 3
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 4, NULL, NULL,
...
\text{Which of the following statements is correct?}', 'LaTeX("A student measures the circumference of a circular room of radius $( 5.00$ m$)$ and obtains the result of $( 31.41$ m$)$.\nWhich of the following statements is correct?").parsingMode(.onlyEquations)', 'LaTeX("A student measures the circumference of a circular room of radius $( 5.00$ m$)$ and obtains the result of $( 31.41$ m$)$.\nWhich of the following statements is correct?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 4
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 5
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 6, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 6
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 10, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 10
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 14
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 18, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 18
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 20
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 23, NULL, NULL,
...
\text{If the speed of sound is } ( 340 \text{ m s}^{-1} ) \text{, what is the waveform''s fundamental frequency?}', 'LaTeX("Item 23 refers to the following diagram which represents the waveform produced when a speaker is held over one open end of a pipe of length $( 85$ cm$)$.\nIf the speed of sound is $( 340$ m s$^{-1} )$, what is the waveform''s fundamental frequency?").parsingMode(.onlyEquations)', 'LaTeX("Item 23 refers to the following diagram which represents the waveform produced when a speaker is held over one open end of a pipe of length $( 85$ cm$)$.\nIf the speed of sound is $( 340$ m s$^{-1} )$, what is the waveform''s fundamental frequency?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 23
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 24, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 24
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 25, NULL, NULL,
...
\text{What is the velocity of the wave?}', 'LaTeX("Item 25 refers to the following two graphs which display the variation of displacement, with time and distance respectively, for the motion of a wave.\nWhat is the velocity of the wave?").parsingMode(.onlyEquations)', 'LaTeX("Item 25 refers to the following two graphs which display the variation of displacement, with time and distance respectively, for the motion of a wave.\nWhat is the velocity of the wave?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 25
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 27, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 27
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 28, NULL, NULL,
...
\text{(Speed of sound in air } = 330 \text{ m s}^{-1} )', 'LaTeX("A ship sends down a pulse of sound to measure the depth of the sea. The echo is detected $( 0.1$ s$)$ later. Assuming that sound waves travel five times faster in sea water than in the air, how deep is the sea at this point?\n(Speed of sound in air $= 330$ m s$^{-1} )$").parsingMode(.onlyEquations)', 'LaTeX("A ship sends down a pulse of sound to measure the depth of the sea. The echo is detected $( 0.1$ s$)$ later. Assuming that sound waves travel five times faster in sea water than in the air, how deep is the sea at this point?\n(Speed of sound in air $= 330$ m s$^{-1} )$").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 28
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 32
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 33, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 33
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 36, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 36
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 37
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 39, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 39
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 40, NULL, NULL,
...
\text{How much work is done in stretching the wire from an extension of } ( 1 \text{ mm} ) \text{ to } ( 2 \text{ mm} ) \text{?}', 'LaTeX("Item 40 refers to the following force-extension graph of a wire.\nHow much work is done in stretching the wire from an extension of $( 1$ mm$)$ to $( 2$ mm$)$?").parsingMode(.onlyEquations)', 'LaTeX("Item 40 refers to the following force-extension graph of a wire.\nHow much work is done in stretching the wire from an extension of $( 1$ mm$)$ to $( 2$ mm$)$?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 40
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 41, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 41
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 42, NULL, NULL,
...
\text{What is the difference in energy stored between the two wires when extended } ( 6 \text{ mm} ) \text{?}', 'LaTeX("Item 42 refers to the following force-extension graph of two different wires.\nWhat is the difference in energy stored between the two wires when extended $( 6$ mm$)$?").parsingMode(.onlyEquations)', 'LaTeX("Item 42 refers to the following force-extension graph of two different wires.\nWhat is the difference in energy stored between the two wires when extended $( 6$ mm$)$?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 42
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 3, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 6, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 8, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 8
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 11, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 11
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
\text{The weight, W, of the plank is}', 'LaTeX("Item 15 refers to the following diagram which shows a uniform plank balanced by forces.\nThe weight, W, of the plank is").parsingMode(.onlyEquations)', 'LaTeX("Item 15 refers to the following diagram which shows a uniform plank balanced by forces.\nThe weight, W, of the plank is").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 15
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 18, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 21, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 21
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 23, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 24, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 28, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 41, NULL, NULL,
...
\text{What will the voltmeter read when the value on the resistance, R, is set at } ( 8.0 \text{ }\Omega )?', 'LaTeX("Item 4 refers to the following diagram of a circuit containing a battery with e.m.f $( 3.0$ V$)$ and internal resistance $( 2.0$ $\\Omega ).$\nWhat will the voltmeter read when the value on the resistance, R, is set at $( 8.0$ $\\Omega )?$").parsingMode(.onlyEquations)', 'LaTeX("Item 4 refers to the following diagram of a circuit containing a battery with e.m.f $( 3.0$ V$)$ and internal resistance $( 2.0$ $\\Omega ).$\nWhat will the voltmeter read when the value on the resistance, R, is set at $( 8.0$ $\\Omega )?$").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U2' AND q.paper = 1 AND q.number = 4
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2024, 'May', 5, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2024, 'May', 6, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U2' AND q.paper = 1 AND q.number = 6
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U2' AND q.paper = 1 AND q.number = 9
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2024, 'May', 14, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U2' AND q.paper = 1 AND q.number = 14
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2024, 'May', 16, NULL, NULL,
...
\text{The battery has negligible internal resistance. Which pair of resistance values would make the voltage between X and Y equal to } ( 1.5 \text{ V} )?', 'LaTeX("Item 16 refers to the following circuit diagram.\nThe battery has negligible internal resistance. Which pair of resistance values would make the voltage between X and Y equal to $( 1.5$ V$)?$").parsingMode(.onlyEquations)', 'LaTeX("Item 16 refers to the following circuit diagram.\nThe battery has negligible internal resistance. Which pair of resistance values would make the voltage between X and Y equal to $( 1.5$ V$)?$").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U2' AND q.paper = 1 AND q.number = 16
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
\text{What would be the output, } ( V_0 ), \text{ given that } ( V_1 = V_3 = 1 \text{ V} ) \text{ and } ( V_2 = 0 )?', 'LaTeX("Item 23 refers to the following diagram which shows a summing amplifier.\nWhat would be the output, $( V_0 ),$ given that $( V_1 = V_3 = 1$ V$)$ and $( V_2 = 0 )?$").parsingMode(.onlyEquations)', 'LaTeX("Item 23 refers to the following diagram which shows a summing amplifier.\nWhat would be the output, $( V_0 ),$ given that $( V_1 = V_3 = 1$ V$)$ and $( V_2 = 0 )?$").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U2' AND q.paper = 1 AND q.number = 23
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U2' AND q.paper = 1 AND q.number = 25
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2024, 'May', 31, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2024, 'May', 34, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U2' AND q.paper = 1 AND q.number = 34
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2024, 'May', 35, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2024, 'May', 38, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U2' AND q.paper = 1 AND q.number = 38
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U2' AND q.paper = 1 AND q.number = 43
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 3, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 6, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 9, NULL, NULL,
...
\text{What is the anticipated acceleration of the object if it takes } ( 16 \text{ s} ) \text{ to complete 20 revolutions?}', 'LaTeX("An object of mass $( 400$ g$)$ is attached to a string. The mass is set in circular motion such that it moves in the horizontal plane with a radius of $( 0.77$ m$)$.\nWhat is the anticipated acceleration of the object if it takes $( 16$ s$)$ to complete 20 revolutions?").parsingMode(.onlyEquations)', 'LaTeX("An object of mass $( 400$ g$)$ is attached to a string. The mass is set in circular motion such that it moves in the horizontal plane with a radius of $( 0.77$ m$)$.\nWhat is the anticipated acceleration of the object if it takes $( 16$ s$)$ to complete 20 revolutions?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 9
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 13, NULL, NULL,
...
\text{Assuming there is no energy loss, what is the speed of the bus at point X?}', 'LaTeX("Item 13 refers to the following diagram showing a bus of mass $( 2000$ kg$)$ travelling down a hill of vertical height $( 50$ m$)$.\nAssuming there is no energy loss, what is the speed of the bus at point X?").parsingMode(.onlyEquations)', 'LaTeX("Item 13 refers to the following diagram showing a bus of mass $( 2000$ kg$)$ travelling down a hill of vertical height $( 50$ m$)$.\nAssuming there is no energy loss, what is the speed of the bus at point X?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 13
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2021, 'May', 14, NULL, NULL,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 19
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2021, 'May', 21, NULL, NULL,
            '\text{A ship sends down a pulse of sound to measure the depth of the sea. The echo is detected } ( 0.1\text{ s} ) \text{ later. Assuming that sound waves travel five times faster in sea water than in the air, how deep is the sea at this point?}
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 22, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 22
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 28, NULL, NULL,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 29
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2021, 'May', 30, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 31, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 31
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 38
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 43, NULL, NULL,
...
\text{Container A with a base area of } ( 2 \text{ cm}^2 ) \text{ is filled with water to a depth of } ( 15 \text{ cm} ) \text{. Some of the water is then emptied and the new height becomes } ( 6 \text{ cm} ) \text{. What is the pressure difference between the two depths?}', 'LaTeX("Item 43 refers to the following diagrams.\nContainer A with a base area of $( 2$ cm$^2 )$ is filled with water to a depth of $( 15$ cm$)$. Some of the water is then emptied and the new height becomes $( 6$ cm$)$. What is the pressure difference between the two depths?").parsingMode(.onlyEquations)', 'LaTeX("Item 43 refers to the following diagrams.\nContainer A with a base area of $( 2$ cm$^2 )$ is filled with water to a depth of $( 15$ cm$)$. Some of the water is then emptied and the new height becomes $( 6$ cm$)$. What is the pressure difference between the two depths?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 43
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
\text{What is the strain energy stored in the wire for an extension of } ( 40 \text{ }\mu\text{m} ) \text{?}', 'LaTeX("Item 44 refers to the following force–extension graph for a stretched wire. OX represents the region where elastic deformation occurs.\nWhat is the strain energy stored in the wire for an extension of $( 40$ $\\mu$m$)$?").parsingMode(.onlyEquations)', 'LaTeX("Item 44 refers to the following force–extension graph for a stretched wire. OX represents the region where elastic deformation occurs.\nWhat is the strain energy stored in the wire for an extension of $( 40$ $\\mu$m$)$?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 44
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Physics U1' AND q.paper = 1 AND q.number = 45
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
\text{The overall balanced chemical equation for the reaction is}', 'LaTeX("Items 5–6 refer to the following half-equations for the reaction between iodine and sodium thiosulfate.\n$( 2$S$_2$O$_3^{2-}$(aq)$\\rightarrow$S$_4$O$_6^{2-}$(aq)$+ 2$e$^- )$\n$($I$_2$(aq)$+ 2$e$^- \\rightarrow 2$I$^-$(aq)$)$\nThe overall balanced chemical equation for the reaction is").parsingMode(.onlyEquations)', 'LaTeX("Items 5–6 refer to the following half-equations for the reaction between iodine and sodium thiosulfate.\n$( 2$S$_2$O$_3^{2-}$(aq)$\\rightarrow$S$_4$O$_6^{2-}$(aq)$+ 2$e$^- )$\n$($I$_2$(aq)$+ 2$e$^- \\rightarrow 2$I$^-$(aq)$)$\nThe overall balanced chemical equation for the reaction is").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 5
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 6
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 7, NULL, NULL,
...
\text{The volume of gas produced when } ( 1.2 \text{ g} ) \text{ of Mg reacts with HCl at r.t.p is}', 'LaTeX("The ionic equation for the reaction of magnesium with hydrochloric acid is\n$($Mg(s)$+ 2$H$^+$(aq)$\\rightarrow$Mg$^{2+}$(aq)$+$H$_2$(g)$)$.\nThe molar volume of a gas at r.t.p. $( = 24$ dm$^3 )$.\nThe volume of gas produced when $( 1.2$ g$)$ of Mg reacts with HCl at r.t.p is").parsingMode(.onlyEquations)', 'LaTeX("The ionic equation for the reaction of magnesium with hydrochloric acid is\n$($Mg(s)$+ 2$H$^+$(aq)$\\rightarrow$Mg$^{2+}$(aq)$+$H$_2$(g)$)$.\nThe molar volume of a gas at r.t.p. $( = 24$ dm$^3 )$.\nThe volume of gas produced when $( 1.2$ g$)$ of Mg reacts with HCl at r.t.p is").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 7
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 8, NULL, NULL,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 14
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2020, 'May', 22, NULL, NULL,
...
\text{The units for the equilibrium constant, } ( \text{K}_c ) \text{, are}', 'LaTeX("Compounds P, Q and R form an equilibrium as shown below.\n$( 2$P(aq)$+$Q(aq)$\\rightleftharpoons 2$R(aq)$)$\nThe units for the equilibrium constant, $($K$_c )$, are").parsingMode(.onlyEquations)', 'LaTeX("Compounds P, Q and R form an equilibrium as shown below.\n$( 2$P(aq)$+$Q(aq)$\\rightleftharpoons 2$R(aq)$)$\nThe units for the equilibrium constant, $($K$_c )$, are").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 22
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 23
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 26, NULL, NULL,
...
( \text{Zn(s)} + \text{Br}_2 \text{(aq)} \rightarrow \text{Zn}^{2+}\text{(aq)} + 2 \text{Br}^-\text{(aq)} )', 'LaTeX("What is the potential for a cell with the following reaction?\n$($Zn(s)$+$Br$_2$(aq)$\\rightarrow$Zn$^{2+}$(aq)$+ 2$Br$^-$(aq)$)$").parsingMode(.onlyEquations)', 'LaTeX("What is the potential for a cell with the following reaction?\n$($Zn(s)$+$Br$_2$(aq)$\\rightarrow$Zn$^{2+}$(aq)$+ 2$Br$^-$(aq)$)$").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 28
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
( \frac{1}{2}\text{H}_2 \text{(g)} + \frac{1}{2}\text{I}_2 \text{(g)} \rightleftharpoons \text{HI(g)} )', 'LaTeX("The value of $($K$_c )$ for the equilibrium\n$($H$_2$(g)$+$I$_2$(g)$\\rightleftharpoons 2$HI(g)$)$\nis 860 at $( 25$ $^\\circ$C$)$.\nWhat is the value of $($K$_c )$ at $( 25$ $^\\circ$C$)$ for the following equilibrium?\n$( \\frac{1}{2}$H$_2$(g)$+ \\frac{1}{2}$I$_2$(g)$\\rightleftharpoons$HI(g)$)$").parsingMode(.onlyEquations)', 'LaTeX("The value of $($K$_c )$ for the equilibrium\n$($H$_2$(g)$+$I$_2$(g)$\\rightleftharpoons 2$HI(g)$)$\nis 860 at $( 25$ $^\\circ$C$)$.\nWhat is the value of $($K$_c )$ at $( 25$ $^\\circ$C$)$ for the following equilibrium?\n$( \\frac{1}{2}$H$_2$(g)$+ \\frac{1}{2}$I$_2$(g)$\\rightleftharpoons$HI(g)$)$").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 29
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
\text{In which of the following equations is the metal UNABLE to reduce } ( \text{Sn}^{2+} ) \text{?}', 'LaTeX("The standard electrode potential of tin (Sn) is $($Sn$^{2+}$(aq)$+ 2$e$^- \\rightleftharpoons$Sn(s)$,$E$^\\circ = -0.14$ V$)$.\nIn which of the following equations is the metal UNABLE to reduce $($Sn$^{2+} )$?").parsingMode(.onlyEquations)', 'LaTeX("The standard electrode potential of tin (Sn) is $($Sn$^{2+}$(aq)$+ 2$e$^- \\rightleftharpoons$Sn(s)$,$E$^\\circ = -0.14$ V$)$.\nIn which of the following equations is the metal UNABLE to reduce $($Sn$^{2+} )$?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 30
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2020, 'May', 45, NULL, NULL,
...
( 4 \text{Cl}_2 \text{(aq)} + \text{S}_2 \text{O}_3^{2-}\text{(aq)} + 5 \text{H}_2 \text{O(l)} \rightarrow 8 \text{Cl}^-\text{(aq)} + 2 \text{SO}_4^{2-}\text{(aq)} + 10 \text{H}^+\text{(aq)} )', 'LaTeX("What deduction can be made from the following reactions of iodine and chlorine with sodium thiosulfate?\n$($I$_2$(aq)$+ 2$S$_2$O$_3^{2-}$(aq)$\\rightarrow 2$I$^-$(aq)$+$S$_4$O$_6^{2-}$(aq)$)$\n$( 4$Cl$_2$(aq)$+$S$_2$O$_3^{2-}$(aq)$+ 5$H$_2$O(l)$\\rightarrow 8$Cl$^-$(aq)$+ 2$SO$_4^{2-}$(aq)$+ 10$H$^+$(aq)$)$").parsingMode(.onlyEquations)', 'LaTeX("What deduction can be made from the following reactions of iodine and chlorine with sodium thiosulfate?\n$($I$_2$(aq)$+ 2$S$_2$O$_3^{2-}$(aq)$\\rightarrow 2$I$^-$(aq)$+$S$_4$O$_6^{2-}$(aq)$)$\n$( 4$Cl$_2$(aq)$+$S$_2$O$_3^{2-}$(aq)$+ 5$H$_2$O(l)$\\rightarrow 8$Cl$^-$(aq)$+ 2$SO$_4^{2-}$(aq)$+ 10$H$^+$(aq)$)$").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 45
          AND (2020 IS NULL OR q.year = 2020)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 4, NULL, NULL,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 9
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
( \text{N}_2 \text{O}_4 \text{(g)} \rightleftharpoons 2 \text{NO}_2 \text{(g), } \Delta \text{H} = +58 \text{ kJ mol}^{-1} )', 'LaTeX("Item 21 refers to the following diagram showing two test tubes with $($N$_2$O$_4 )$ under different conditions.\nWhat will be observed in Test Tubes I and II for the following gaseous equilibrium?\n$($N$_2$O$_4$(g)$\\rightleftharpoons 2$NO$_2$(g), $\\Delta$H$= +58$ kJ mol$^{-1} )$").parsingMode(.onlyEquations)', 'LaTeX("Item 21 refers to the following diagram showing two test tubes with $($N$_2$O$_4 )$ under different conditions.\nWhat will be observed in Test Tubes I and II for the following gaseous equilibrium?\n$($N$_2$O$_4$(g)$\\rightleftharpoons 2$NO$_2$(g), $\\Delta$H$= +58$ kJ mol$^{-1} )$").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 21
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 23, NULL, NULL,
...
\text{The units for the equilibrium constant, } ( \text{K}_c ) \text{, are}', 'LaTeX("Compounds P, Q and R form an equilibrium as shown below.\n$( 2$P(aq)$+$Q(aq)$\\rightleftharpoons 2$R(aq)$)$\nThe units for the equilibrium constant, $($K$_c )$, are").parsingMode(.onlyEquations)', 'LaTeX("Compounds P, Q and R form an equilibrium as shown below.\n$( 2$P(aq)$+$Q(aq)$\\rightleftharpoons 2$R(aq)$)$\nThe units for the equilibrium constant, $($K$_c )$, are").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 27
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2021, 'May', 33, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 33
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 2, NULL, NULL,
...
\text{Which of the following statements is NOT a possible assumption?}', 'LaTeX("To determine why a hairdresser stores her bottle of $($H$_2$O$_2 )$ in the refrigerator, a student sets up the apparatus shown below and recorded the volume of gas in the syringe every 30 seconds for 3 minutes. This activity was done in a dark room, at room temperature and in a dark room at $( 5$ $^\\circ$C$)$.\nWhich of the following statements is NOT a possible assumption?").parsingMode(.onlyEquations)', 'LaTeX("To determine why a hairdresser stores her bottle of $($H$_2$O$_2 )$ in the refrigerator, a student sets up the apparatus shown below and recorded the volume of gas in the syringe every 30 seconds for 3 minutes. This activity was done in a dark room, at room temperature and in a dark room at $( 5$ $^\\circ$C$)$.\nWhich of the following statements is NOT a possible assumption?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 2
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
\text{Which of the following processes occurs as the cell operates?}', 'LaTeX("Items 16–18 refer to the following diagram of an electrochemical cell.\n$($Au$^{3+}$(aq)$+ 3$e$^- \\rightarrow$Au(s), $+1.50$V$)$\n$($Pb$^{2+}$(aq)$+ 2$e$^- \\rightarrow$Pb(s), $-0.13$V$)$\nWhich of the following processes occurs as the cell operates?").parsingMode(.onlyEquations)', 'LaTeX("Items 16–18 refer to the following diagram of an electrochemical cell.\n$($Au$^{3+}$(aq)$+ 3$e$^- \\rightarrow$Au(s), $+1.50$V$)$\n$($Pb$^{2+}$(aq)$+ 2$e$^- \\rightarrow$Pb(s), $-0.13$V$)$\nWhich of the following processes occurs as the cell operates?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 16
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 17, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 17
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 22, NULL, NULL,
            '\text{Compounds P, Q and R form an equilibrium as shown below.}
( 2\text{P(aq)} + \text{Q(aq)} \rightleftharpoons 2\text{R(aq)} )
\text{The units for the equilibrium constant, } ( \text{K}_c )\text{, are}', '\text{Compounds P, Q and R form an equilibrium as shown below.}
( 2 \text{P(aq)} + \text{Q(aq)} \rightleftharpoons 2 \text{R(aq)} )
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 26, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 29, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 36, NULL, NULL,
            '\text{Which of the following compounds would produce the LOWEST pH when } ( 0.5\text{ mol} ) \text{ of it is bubbled into 1 litre of water?}', '\text{Which of the following compounds would produce the LOWEST pH when } ( 0.5 \text{ mol} ) \text{ of it is bubbled into 1 litre of water?}', 'LaTeX("Which of the following compounds would produce the LOWEST pH when $( 0.5$ mol$)$ of it is bubbled into 1 litre of water?").parsingMode(.onlyEquations)', 'LaTeX("Which of the following compounds would produce the LOWEST pH when $( 0.5$ mol$)$ of it is bubbled into 1 litre of water?").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 1 AND q.number = 36
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 2
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
\text{Which of the following sets of pH values is LIKELY to be for the amines, X, Y and Z respectively?}', 'LaTeX("Item 3 refers to the three amines, X, Y and Z, with the following formulae.\nX: $($CH$_2$Cl CHCl NH$_2 )$\nY: $($CH$_3$ CH$_2$ NH$_2 )$\nZ: $($C$_6$H$_5$CH$_2$ NH$_2 )$\nWhich of the following sets of pH values is LIKELY to be for the amines, X, Y and Z respectively?").parsingMode(.onlyEquations)', 'LaTeX("Item 3 refers to the three amines, X, Y and Z, with the following formulae.\nX: $($CH$_2$Cl CHCl NH$_2 )$\nY: $($CH$_3$ CH$_2$ NH$_2 )$\nZ: $($C$_6$H$_5$CH$_2$ NH$_2 )$\nWhich of the following sets of pH values is LIKELY to be for the amines, X, Y and Z respectively?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 3
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 6
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 7, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 7
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 9, NULL, NULL,
...
\text{The correct sequence of the compounds, in order of DECREASING acid strength, is}', 'LaTeX("Item 9 refers to the compounds, P, Q, R and S, with the following structures.\nS: $($C$_6$H$_5$OH$)$\nP: $($CH$_3($CH$_2)_4$CH$_2$OH$)$\nQ: $($CH$_3($CH$_2)_4$CH$_2$COOH$)$\nR: $($CH$_3($CH$_2)_3$CHClCOOH$)$\nThe correct sequence of the compounds, in order of DECREASING acid strength, is").parsingMode(.onlyEquations)', 'LaTeX("Item 9 refers to the compounds, P, Q, R and S, with the following structures.\nS: $($C$_6$H$_5$OH$)$\nP: $($CH$_3($CH$_2)_4$CH$_2$OH$)$\nQ: $($CH$_3($CH$_2)_4$CH$_2$COOH$)$\nR: $($CH$_3($CH$_2)_3$CHClCOOH$)$\nThe correct sequence of the compounds, in order of DECREASING acid strength, is").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 9
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 12, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 12
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 16
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 31, NULL, NULL,
...
\text{Which of the following options describes the effect of adding the catalyst } ( \text{V}_2 \text{O}_5 ) \text{ to the mixture?}', 'LaTeX("In one of the steps involved in the manufacture of sulfuric acid, sulfur dioxide and oxygen are mixed to form sulfur trioxide according to the following equation:\n$( 2$SO$_2$(g)$+$O$_2$(g)$\\rightarrow 2$SO$_3$(g)$)$\nWhich of the following options describes the effect of adding the catalyst $($V$_2$O$_5 )$ to the mixture?").parsingMode(.onlyEquations)', 'LaTeX("In one of the steps involved in the manufacture of sulfuric acid, sulfur dioxide and oxygen are mixed to form sulfur trioxide according to the following equation:\n$( 2$SO$_2$(g)$+$O$_2$(g)$\\rightarrow 2$SO$_3$(g)$)$\nWhich of the following options describes the effect of adding the catalyst $($V$_2$O$_5 )$ to the mixture?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 31
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 34, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 35, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 39, NULL, NULL,
...
\text{Why is a moderate pressure used in industry rather than high pressure?}', 'LaTeX("From the reaction given below, a high pressure would give the best yield, but in industry, a moderate pressure is used.\n$($N$_2$(g)$+ 3$H$_2$(g)$\\rightleftharpoons 2$NH$_3$(g)$)$\nWhy is a moderate pressure used in industry rather than high pressure?").parsingMode(.onlyEquations)', 'LaTeX("From the reaction given below, a high pressure would give the best yield, but in industry, a moderate pressure is used.\n$($N$_2$(g)$+ 3$H$_2$(g)$\\rightleftharpoons 2$NH$_3$(g)$)$\nWhy is a moderate pressure used in industry rather than high pressure?").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 39
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 40
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 42, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 42
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 45, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 45
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2023, 'May', 1, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 1
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 2, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 6, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 8, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 8
          AND (2023 IS NULL OR q.year = 2023)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2023, 'May', 9, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 10, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 10
          AND (2023 IS NULL OR q.year = 2023)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2023, 'May', 11, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 11
          AND (2023 IS NULL OR q.year = 2023)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2023, 'May', 12, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 15, NULL, NULL,
            '\text{An alcohol is treated with acidified } ( \text{K}_2\text{Cr}_2\text{O}_7 ) \text{ and the resulting mixture gives a positive tri-iodoform test. Which of the following structures BEST represents the alcohol used?}', '\text{An alcohol is treated with acidified } ( \text{K}_2 \text{Cr}_2 \text{O}_7 ) \text{ and the resulting mixture gives a positive tri-iodoform test. Which of the following structures BEST represents the alcohol used?}', 'LaTeX("An alcohol is treated with acidified $($K$_2$Cr$_2$O$_7 )$ and the resulting mixture gives a positive tri-iodoform test. Which of the following structures BEST represents the alcohol used?").parsingMode(.onlyEquations)', 'LaTeX("An alcohol is treated with acidified $($K$_2$Cr$_2$O$_7 )$ and the resulting mixture gives a positive tri-iodoform test. Which of the following structures BEST represents the alcohol used?").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 15
          AND (2023 IS NULL OR q.year = 2023)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2023, 'May', 26, NULL, NULL,
...
\text{In a titration, } ( 25 \text{ cm}^3 ) \text{ of } ( 0.04 \text{ mol dm}^{-3} ) \text{ sodium sulfite solution required } ( 20 \text{ cm}^3 ) \text{ of acidified } ( \text{KMnO}_4 \text{ for complete oxidation. The concentration of } \text{KMnO}_4 \text{ is} )', 'LaTeX("Sodium sulfite reacts with potassium manganate(VII) according to the following equation.\n$( 2$MnO$_4^- + 6$H$^+ + 5$SO$_3^{2-} \\to 2$Mn$^{2+} + 3$H$_2$O$+ 5$SO$_4^{2-} )$\nIn a titration, $( 25$ cm$^3 )$ of $( 0.04$ mol dm$^{-3} )$ sodium sulfite solution required $( 20$ cm$^3 )$ of acidified $($KMnO$_4$ for complete oxidation. The concentration of KMnO$_4$ is$)$").parsingMode(.onlyEquations)', 'LaTeX("Sodium sulfite reacts with potassium manganate(VII) according to the following equation.\n$( 2$MnO$_4^- + 6$H$^+ + 5$SO$_3^{2-} \\to 2$Mn$^{2+} + 3$H$_2$O$+ 5$SO$_4^{2-} )$\nIn a titration, $( 25$ cm$^3 )$ of $( 0.04$ mol dm$^{-3} )$ sodium sulfite solution required $( 20$ cm$^3 )$ of acidified $($KMnO$_4$ for complete oxidation. The concentration of KMnO$_4$ is$)$").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 26
          AND (2023 IS NULL OR q.year = 2023)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2023, 'May', 33, NULL, NULL,
...
\text{In the balanced equations, X and Y would be}', 'LaTeX("The two equations below summarize the fermentation process for the production of alcohol.\nI. $($X$+$H$_2$O$+$Invertase$\\to 2$ C$_6$H$_{12}$O$_6 )$\nII. $($C$_6$H$_{12}$O$_6 +$Zymase$\\to 2$ C$_2$H$_5$OH$+$Y$)$\nIn the balanced equations, X and Y would be").parsingMode(.onlyEquations)', 'LaTeX("The two equations below summarize the fermentation process for the production of alcohol.\nI. $($X$+$H$_2$O$+$Invertase$\\to 2$ C$_6$H$_{12}$O$_6 )$\nII. $($C$_6$H$_{12}$O$_6 +$Zymase$\\to 2$ C$_2$H$_5$OH$+$Y$)$\nIn the balanced equations, X and Y would be").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 33
          AND (2023 IS NULL OR q.year = 2023)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2023, 'May', 35, NULL, NULL,
            '\text{What is the product of the following (unbalanced) equation?}
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 42, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2025, 'May', 5, NULL, NULL,
            '\text{Which of the following compounds is hydrolysed by water?}', '\text{Which of the following compounds is hydrolysed by water?}', 'LaTeX("Which of the following compounds is hydrolysed by water?").parsingMode(.onlyEquations)', 'LaTeX("Which of the following compounds is hydrolysed by water?").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 5
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2025, 'May', 9, NULL, NULL,
            '\text{Item 9 refers to the following species structure which shows the product of reaction between a halogenoalkane and NaOH (aq). Which of the following is likely to be the product of the first step in the reaction mechanism for the reaction above?}', '\text{Item 9 refers to the following species structure which shows the product of reaction between a halogenoalkane and NaOH (aq). Which of the following is likely to be the product of the first step in the reaction mechanism for the reaction above?}', 'LaTeX("Item 9 refers to the following species structure which shows the product of reaction between a halogenoalkane and NaOH (aq). Which of the following is likely to be the product of the first step in the reaction mechanism for the reaction above?").parsingMode(.onlyEquations)', 'LaTeX("Item 9 refers to the following species structure which shows the product of reaction between a halogenoalkane and NaOH (aq). Which of the following is likely to be the product of the first step in the reaction mechanism for the reaction above?").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2025, 'May', 12, NULL, NULL,
            '\text{Nylon 6,6 can be made by the condensation polymerization of } ( \text{H}_2\text{N(CH}_2\text{)}_6\text{NH}_2 ) \text{ and } ( \text{HOOC(CH}_2\text{)}_4\text{COOH.} ) \text{ The repeat unit is}', '\text{Nylon 6,6 can be made by the condensation polymerization of } ( \text{H}_2 \text{N(CH}_2 \text{)}_6 \text{NH}_2 ) \text{ and } ( \text{HOOC(CH}_2 \text{)}_4 \text{COOH.} ) \text{ The repeat unit is}', 'LaTeX("Nylon 6,6 can be made by the condensation polymerization of $($H$_2$N(CH$_2$)$_6$NH$_2 )$ and $($HOOC(CH$_2$)$_4$COOH.$)$ The repeat unit is").parsingMode(.onlyEquations)', 'LaTeX("Nylon 6,6 can be made by the condensation polymerization of $($H$_2$N(CH$_2$)$_6$NH$_2 )$ and $($HOOC(CH$_2$)$_4$COOH.$)$ The repeat unit is").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2025, 'May', 14, NULL, NULL,
            '\text{The halogenoalkane } ( \text{(CH}_3\text{)}_3\text{CX (X = halogen),} ) \text{ when treated with aqueous sodium hydroxide, undergoes a substitution reaction. Which of the following reaction sequences shows the mechanism for this reaction?}', '\text{The halogenoalkane } ( \text{(CH}_3 \text{)}_3 \text{CX (X = halogen),} ) \text{ when treated with aqueous sodium hydroxide, undergoes a substitution reaction. Which of the following reaction sequences shows the mechanism for this reaction?}', 'LaTeX("The halogenoalkane $($(CH$_3$)$_3$CX (X = halogen),$)$ when treated with aqueous sodium hydroxide, undergoes a substitution reaction. Which of the following reaction sequences shows the mechanism for this reaction?").parsingMode(.onlyEquations)', 'LaTeX("The halogenoalkane $($(CH$_3$)$_3$CX (X = halogen),$)$ when treated with aqueous sodium hydroxide, undergoes a substitution reaction. Which of the following reaction sequences shows the mechanism for this reaction?").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 18
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2025, 'May', 26, NULL, NULL,
            '\text{Sodium sulfite reacts with potassium manganate(VII) according to the following equation.}
( 2\text{MnO}_4^- + 6\text{H}^+ + 5\text{SO}_3^{2-} \to 2\text{Mn}^{2+} + 3\text{H}_2\text{O} + 5\text{SO}_4^{2-} )
\text{In a titration, } ( 25 \text{ cm}^3 ) \text{ of } ( 0.04 \text{ mol dm}^{-3} ) \text{ sodium sulfite solution required } ( 20 \text{ cm}^3 ) \text{ of acidified } ( \text{KMnO}_4 \text{ for complete oxidation. The concentration of } \text{KMnO}_4 \text{ is} )', '\text{Sodium sulfite reacts with potassium manganate(VII) according to the following equation.}
( 2 \text{MnO}_4^- + 6 \text{H}^+ + 5 \text{SO}_3^{2-} \to 2 \text{Mn}^{2+} + 3 \text{H}_2 \text{O} + 5 \text{SO}_4^{2-} )
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2025, 'May', 29, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2025, 'May', 33, NULL, NULL,
            '\text{The two equations below summarize the fermentation process for the production of alcohol.}
\text{I. } ( \text{X} + \text{H}_2\text{O} + \text{Invertase} \to 2\text{ C}_6\text{H}_{12}\text{O}_6 )
\text{II. } ( \text{C}_6\text{H}_{12}\text{O}_6 + \text{Zymase} \to 2\text{ C}_2\text{H}_5\text{OH} + \text{Y} )
\text{In the balanced equations, X and Y would be}', '\text{The two equations below summarize the fermentation process for the production of alcohol.}
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2025, 'May', 34, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2025, 'May', 43, NULL, NULL,
...
\text{III. Low temperature}', 'LaTeX("In the production of sulfuric acid by the Contact process, the following exothermic reaction takes place:\n$( 2$SO$_2$(g) + O$_2$(g)$\\xrightleftharpoons[$420 $^\\circ$C, 2 atm$]{$V$_2$O$_5} 2$SO$_3$(g)$)$\nWhich of the following condition(s) would favour the forward reaction?\nI. Low pressure\nII. Excess oxygen\nIII. Low temperature").parsingMode(.onlyEquations)', 'LaTeX("In the production of sulfuric acid by the Contact process, the following exothermic reaction takes place:\n$( 2$SO$_2$(g) + O$_2$(g)$\\xrightleftharpoons[$420 $^\\circ$C, 2 atm$]{$V$_2$O$_5} 2$SO$_3$(g)$)$\nWhich of the following condition(s) would favour the forward reaction?\nI. Low pressure\nII. Excess oxygen\nIII. Low temperature").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 1 AND q.number = 43
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Biology U1' AND q.paper = 1 AND q.number = 36
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2022, 'May', 1, NULL, NULL,
...
III. \text{Density decreases below } ( 4 \text{ }^\circ\text{C} )', 'LaTeX("Which of the following characteristics of water are of biological significance?\n$I.$Excellent solvent properties\n$II.$Relatively high heat capacity\n$III.$Density decreases below $( 4$ $^\\circ$C$)$").parsingMode(.onlyEquations)', 'LaTeX("Which of the following characteristics of water are of biological significance?\n$I.$Excellent solvent properties\n$II.$Relatively high heat capacity\n$III.$Density decreases below $( 4$ $^\\circ$C$)$").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Biology U1' AND q.paper = 1 AND q.number = 1
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 5
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
 ...
 \text{may be represented by}', 'LaTeX("Using summation notation, the series\n$3 - 9 + 27 - 81 + \\dots - 729$\nmay be represented by").parsingMode(.onlyEquations)', 'LaTeX("Using summation notation, the series\n$3 - 9 + 27 - 81 + \\dots - 729$\nmay be represented by").parsingMode(.onlyEquations)',
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 6
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 17
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2025, 'May', 19, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 19
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 20
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 26
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2025, 'May', 27, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 27
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2025, 'May', 28, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 28
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 29
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 35
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2025, 'May', 37, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 37
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 43
          AND (2025 IS NULL OR q.year = 2025)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2024, 'May', 1, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 1
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 2
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 18
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2024, 'May', 26, NULL, NULL,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 34
          AND (2024 IS NULL OR q.year = 2024)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2024, 'May', 36, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 3, NULL, NULL,
            '\frac{\sqrt{x}-\sqrt{y}}{\sqrt{x}+\sqrt{y}} \text{ may be expressed as}', '\frac{\sqrt{x}-\sqrt{y}}{\sqrt{x}+\sqrt{y}} \text{ may be expressed as}', 'LaTeX("$\\frac{\\sqrt{x}-\\sqrt{y}}{\\sqrt{x}+\\sqrt{y}}$ may be expressed as").parsingMode(.onlyEquations)', 'LaTeX("$\\frac{\\sqrt{x}-\\sqrt{y}}{\\sqrt{x}+\\sqrt{y}}$ may be expressed as").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 3
          AND (2023 IS NULL OR q.year = 2023)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 17, NULL, NULL,
            '\text{The angle between the vectors } \mathbf{a} = 2\mathbf{i} - \mathbf{j} + 2\mathbf{k} \text{ and } \mathbf{b} = \mathbf{i} + 4\mathbf{j} + \mathbf{k} \text{ is}', '\text{The angle between the vectors } \mathbf{a} = 2 \mathbf{i} - \mathbf{j} + 2 \mathbf{k} \text{ and } \mathbf{b} = \mathbf{i} + 4 \mathbf{j} + \mathbf{k} \text{ is}', 'LaTeX("The angle between the vectors $\\mathbf{a} = 2\\mathbf{i} - \\mathbf{j} + 2\\mathbf{k}$ and $\\mathbf{b} = \\mathbf{i} + 4\\mathbf{j} + \\mathbf{k}$ is").parsingMode(.onlyEquations)', 'LaTeX("The angle between the vectors $\\mathbf{a} = 2 \\mathbf{i} - \\mathbf{j} + 2 \\mathbf{k}$ and $\\mathbf{b} = \\mathbf{i} + 4 \\mathbf{j} + \\mathbf{k}$ is").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 25, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 25
          AND (2023 IS NULL OR q.year = 2023)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2023, 'May', 27, NULL, NULL,
            '\text{The vector } \mathbf{u} \text{ has magnitude } 4\sqrt{5} \text{ units and is parallel to the vector } \mathbf{v} = \mathbf{i} - 2\mathbf{j} \text{. A unit vector parallel to } \mathbf{u} \text{ is}', '\text{The vector } \mathbf{u} \text{ has magnitude } 4 \sqrt{5} \text{ units and is parallel to the vector } \mathbf{v} = \mathbf{i} - 2 \mathbf{j} \text{. A unit vector parallel to } \mathbf{u} \text{ is}', 'LaTeX("The vector $\\mathbf{u}$ has magnitude $4\\sqrt{5}$ units and is parallel to the vector $\\mathbf{v} = \\mathbf{i} - 2\\mathbf{j}$. A unit vector parallel to $\\mathbf{u}$ is").parsingMode(.onlyEquations)', 'LaTeX("The vector $\\mathbf{u}$ has magnitude $4 \\sqrt{5}$ units and is parallel to the vector $\\mathbf{v} = \\mathbf{i} - 2 \\mathbf{j}$. A unit vector parallel to $\\mathbf{u}$ is").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 29, NULL, NULL,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 43, NULL, NULL,
            '\text{The portion of the curve } y = 2x \text{ between } x = a \text{ and } x = b \text{ is rotated } 360^\circ \, (2\pi \, \text{radians}) \text{ about the } x \text{-axis. The volume, } v \text{, of the solid generated is BEST represented as}', '\text{The portion of the curve } y = 2x \text{ between } x = a \text{ and } x = b \text{ is rotated } 360^\circ \, (2 \pi \, \text{radians}) \text{ about the } x \text{-axis. The volume, } v \text{, of the solid generated is BEST represented as}', 'LaTeX("The portion of the curve $y = 2x$ between $x = a$ and $x = b$ is rotated $360^\\circ \\, (2\\pi \\,$radians$)$ about the $x$-axis. The volume, $v$, of the solid generated is BEST represented as").parsingMode(.onlyEquations)', 'LaTeX("The portion of the curve $y = 2x$ between $x = a$ and $x = b$ is rotated $360^\\circ \\, (2 \\pi \\,$radians$)$ about the $x$-axis. The volume, $v$, of the solid generated is BEST represented as").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2023, 'May', 44, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 44
          AND (2023 IS NULL OR q.year = 2023)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 4
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 21
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 24
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 31
          AND (2022 IS NULL OR q.year = 2022)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 1, 2022, 'May', 43, NULL, NULL,
            '\text{The portion of the curve } y = 2x \text{ between } x = a \text{ and } x = b \text{ is rotated } 360^\circ \, (2\pi \, \text{radians}) \text{ about the } x\text{-axis. The volume, } v\text{, of the solid generated is BEST represented as}', '\text{The portion of the curve } y = 2x \text{ between } x = a \text{ and } x = b \text{ is rotated } 360^\circ \, (2 \pi \, \text{radians}) \text{ about the } x\text{-axis. The volume, } v\text{, of the solid generated is BEST represented as}', 'LaTeX("The portion of the curve $y = 2x$ between $x = a$ and $x = b$ is rotated $360^\\circ \\, (2\\pi \\,$radians$)$ about the $x$-axis. The volume, $v$, of the solid generated is BEST represented as").parsingMode(.onlyEquations)', 'LaTeX("The portion of the curve $y = 2x$ between $x = a$ and $x = b$ is rotated $360^\\circ \\, (2 \\pi \\,$radians$)$ about the $x$-axis. The volume, $v$, of the solid generated is BEST represented as").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 15
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2021, 'May', 16, NULL, NULL,
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 16
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2021, 'May', 17, NULL, NULL,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 22
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 33
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
            ...
            q.id, s.name, 1, 2021, 'May', 34, NULL, NULL,
            '\text{A dial on a plane preparing for landing registers the number } 200 + 5 \left[ \frac{\sin h}{h} \right] \text{, where } h \text{ is the height above the ground. Just as the plane lands the dial reads}', '\text{A dial on a plane preparing for landing registers the number } 200 + 5 \left[ \frac{\sin h}{h} \right] \text{, where } h \text{ is the height above the ground. Just as the plane lands the dial reads}', 'LaTeX("A dial on a plane preparing for landing registers the number $200 + 5 \\left[ \\frac{\\sin h}{h} \\right]$, where $h$ is the height above the ground. Just as the plane lands the dial reads").parsingMode(.onlyEquations)', 'LaTeX("A dial on a plane preparing for landing registers the number $200 + 5 \\left[ \\frac{\\sin h}{h} \\right]$, where $h$ is the height above the ground. Just as the plane lands the dial reads").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 41
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 1 AND q.number = 45
          AND (2021 IS NULL OR q.year = 2021)
        LIMIT 1;
INSERT INTO fixed_questions (
            original_question_id, subject_name, paper, year, month, number, part, subpart,
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 3, 'c', 'ii',
            '\text{Hence, use the method of differences to show that }  \sum_{r=1}^n \frac{4}{(2r+1)(2r+3)} = 2 \left( \frac{1}{3} - \frac{1}{2n+3} \right) \text{.}', '\text{Hence, use the method of differences to show that }  \sum_{(r=1)}^n \frac{4}{(2r+1)(2r+3)} = 2 \left( \frac{1}{3} - \frac{1}{2n+3} \right) \text{.}', 'LaTeX("Hence, use the method of differences to show that  $\\sum_{r=1}^n \\frac{4}{(2r+1)(2r+3)} = 2 \\left( \\frac{1}{3} - \\frac{1}{2n+3} \\right)$.").parsingMode(.onlyEquations)', 'LaTeX("Hence, use the method of differences to show that  $\\sum_{(r=1)}^n \\frac{4}{(2r+1)(2r+3)} = 2 \\left( \\frac{1}{3} - \\frac{1}{2n+3} \\right)$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 3, 'c', 'iii',
            '\text{Hence, calculate }  \sum_{r=1}^{\infty} \frac{4}{(2r+1)(2r+3)} \text{.}', '\text{Hence, calculate }  \sum_{(r=1)}^{\infty} \frac{4}{(2r+1)(2r+3)} \text{.}', 'LaTeX("Hence, calculate  $\\sum_{r=1}^{\\infty} \\frac{4}{(2r+1)(2r+3)}$.").parsingMode(.onlyEquations)', 'LaTeX("Hence, calculate  $\\sum_{(r=1)}^{\\infty} \\frac{4}{(2r+1)(2r+3)}$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 2 AND q.number = 3
...
INSERT INTO fixed_questions (
        ...
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U2' AND q.paper = 2 AND q.number = 1
          AND (2024 IS NULL OR q.year = 2024)
          AND q.part = 'b'
          AND q.subpart = 'i'
        LIMIT 1;
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2024, 'May', 4, 'c', 'i',
            '\text{Calculate }  \sum_{r=11}^{27} r .', '\text{Calculate }  \sum_{(r=11)}^{27} r .', 'LaTeX("Calculate  $\\sum_{r=11}^{27} r$.").parsingMode(.onlyEquations)', 'LaTeX("Calculate  $\\sum_{(r=11)}^{27} r$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            '\text{Derive the identity for }  \cos 2\theta  \text{ in terms of }  \cos \theta  \text{ only.}', '\text{Derive the identity for }  \cos 2 \theta  \text{ in terms of }  \cos \theta  \text{ only.}', 'LaTeX("Derive the identity for  $\\cos 2\\theta$  in terms of  $\\cos \\theta$  only.").parsingMode(.onlyEquations)', 'LaTeX("Derive the identity for  $\\cos 2 \\theta$  in terms of  $\\cos \\theta$  only.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 3
          AND (2026 IS NULL OR q.year = 2026)
          AND q.part = 'b'
          AND q.subpart = 'i'
        LIMIT 1;
INSERT INTO fixed_questions (
            ...
            '\text{Hence, solve }  \cos 2\theta - 3 \cos \theta = 1  \text{ for }  0 \leq \theta \leq 2\pi .', '\text{Hence, solve }  \cos 2 \theta - 3 \cos \theta = 1  \text{ for }  0 \leq \theta \leq 2 \pi .', 'LaTeX("Hence, solve  $\\cos 2\\theta - 3 \\cos \\theta = 1$  for  $0 \\leq \\theta \\leq 2\\pi$.").parsingMode(.onlyEquations)', 'LaTeX("Hence, solve  $\\cos 2 \\theta - 3 \\cos \\theta = 1$  for  $0 \\leq \\theta \\leq 2 \\pi$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 3
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 4, 'b', 'i',
            '\text{Vectors }  \mathbf{a}  \text{ and }  \mathbf{b}  \text{ are such that }  \mathbf{a} = 3\mathbf{i} + 4\mathbf{j}  \text{ and }  \mathbf{b} = -2\mathbf{i} + \mathbf{j} . \text{ Calculate }  \mathbf{a} \cdot \mathbf{b} .', '\text{Vectors }  \mathbf{a}  \text{ and }  \mathbf{b}  \text{ are such that }  \mathbf{a} = 3 \mathbf{i} + 4 \mathbf{j}  \text{ and }  \mathbf{b} = -2 \mathbf{i} + \mathbf{j} . \text{ Calculate }  \mathbf{a} \cdot \mathbf{b} .', 'LaTeX("Vectors  $\\mathbf{a}$  and  $\\mathbf{b}$  are such that  $\\mathbf{a} = 3\\mathbf{i} + 4\\mathbf{j}$  and  $\\mathbf{b} = -2\\mathbf{i} + \\mathbf{j}$.  Calculate  $\\mathbf{a} \\cdot \\mathbf{b}$.").parsingMode(.onlyEquations)', 'LaTeX("Vectors  $\\mathbf{a}$  and  $\\mathbf{b}$  are such that  $\\mathbf{a} = 3 \\mathbf{i} + 4 \\mathbf{j}$  and  $\\mathbf{b} = -2 \\mathbf{i} + \\mathbf{j}$.  Calculate  $\\mathbf{a} \\cdot \\mathbf{b}$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 4
          AND (2026 IS NULL OR q.year = 2026)
          AND q.part = 'b'
          AND q.subpart = 'i'
        LIMIT 1;
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 4, 'd', 'i',
            '\text{Determine the vector equation of the plane that passes through the point }  (1, -1, 2)  \text{ and that is perpendicular to the vector }  2\mathbf{i} + 3\mathbf{j} - \mathbf{k} .', '\text{Determine the vector equation of the plane that passes through the point }  (1, -1, 2)  \text{ and that is perpendicular to the vector }  2 \mathbf{i} + 3 \mathbf{j} - \mathbf{k} .', 'LaTeX("Determine the vector equation of the plane that passes through the point  $(1, -1, 2)$  and that is perpendicular to the vector  $2\\mathbf{i} + 3\\mathbf{j} - \\mathbf{k}$.").parsingMode(.onlyEquations)', 'LaTeX("Determine the vector equation of the plane that passes through the point  $(1, -1, 2)$  and that is perpendicular to the vector  $2 \\mathbf{i} + 3 \\mathbf{j} - \\mathbf{k}$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 4
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 5, 'a', 'i',
            '\text{a) Determine the value of }  \lim_{x \to -5^+} f(x) 
\text{b) Determine the value of }  \lim_{x \to 5} f(x) .', '\text{a) Determine the value of }  \lim_{(x \to -5^+)} f(x) 
\text{b) Determine the value of }  \lim_{(x \to 5)} f(x) .', 'LaTeX("a) Determine the value of  $\\lim_{x \\to -5^+} f(x)$\nb) Determine the value of  $\\lim_{x \\to 5} f(x)$.").parsingMode(.onlyEquations)', 'LaTeX("a) Determine the value of  $\\lim_{(x \\to -5^+)} f(x)$\nb) Determine the value of  $\\lim_{(x \\to 5)} f(x)$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 5, 'a', 'ii',
            '\text{State the value of }  k  \text{ such that }  \lim_{x \to k} f(x) = -2 .', '\text{State the value of }  k  \text{ such that }  \lim_{(x \to k)} f(x) = -2 .', 'LaTeX("State the value of  $k$  such that  $\\lim_{x \\to k} f(x) = -2$.").parsingMode(.onlyEquations)', 'LaTeX("State the value of  $k$  such that  $\\lim_{(x \\to k)} f(x) = -2$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 5
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 5, 'b', 'i',
            '\text{a) Determine }  g(1) 
\text{b) Determine }  \lim_{x \to 1} g(x) .', '\text{a) Determine }  g(1) 
\text{b) Determine }  \lim_{(x \to 1)} g(x) .', 'LaTeX("a) Determine  $g(1)$\nb) Determine  $\\lim_{x \\to 1} g(x)$.").parsingMode(.onlyEquations)', 'LaTeX("a) Determine  $g(1)$\nb) Determine  $\\lim_{(x \\to 1)} g(x)$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 5
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2025, 'May', 4, 'a', 'i',
            '\text{Show that }  \frac{1 - \cos 2\alpha}{\sin 2\alpha} \equiv \tan \alpha.', '\text{Show that }  \frac{1 - \cos 2 \alpha}{\sin 2 \alpha} \equiv \tan \alpha.', 'LaTeX("Show that  $\\frac{1 - \\cos 2\\alpha}{\\sin 2\\alpha} \\equiv \\tan \\alpha.$").parsingMode(.onlyEquations)', 'LaTeX("Show that  $\\frac{1 - \\cos 2 \\alpha}{\\sin 2 \\alpha} \\equiv \\tan \\alpha.$").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 4
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2025, 'May', 5, 'a', 'i',
            '\text{Evaluate }  \lim_{x \to 0} \frac{\sin 3x}{2x}.', '\text{Evaluate }  \lim_{(x \to 0)} \frac{\sin 3x}{2x}.', 'LaTeX("Evaluate  $\\lim_{x \\to 0} \\frac{\\sin 3x}{2x}.$").parsingMode(.onlyEquations)', 'LaTeX("Evaluate  $\\lim_{(x \\to 0)} \\frac{\\sin 3x}{2x}.$").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 5
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2025, 'May', 5, 'd', 'i',
            '\text{Water is flowing into an empty right circular cone at a constant rate of }  8\,\text{cm}^3  \text{ per minute. The depth of the liquid in the cone at time, }  t,  \text{ in minutes, is }  x\,\text{cm}. 
\text{The angle, }  \alpha,  \text{ between the perpendicular height, }  h,  \text{ of the cone and the slant height is}
 \tan^{-1} \frac{\sqrt{3}}{3}  \text{ and the volume of the cone can be calculated as }  V = \frac{1}{3} \pi r^2 h. 
\text{(i) Show that the volume, }  V\,\text{cm}^3,  \text{ of water in the cone when the depth is }  x\,\text{cm}  \text{ can be}
\text{expressed as }  V = \frac{1}{9} \pi x^3.', '\text{Water is flowing into an empty right circular cone at a constant rate of }  8\,\text{cm}^3  \text{ per minute. The depth of the liquid in the cone at time, }  t,  \text{ in minutes, is }  x\,\text{cm}. 
\text{The angle, }  \alpha,  \text{ between the perpendicular height, }  h,  \text{ of the cone and the slant height is}
 \tan^{(-1)} \frac{\sqrt{3}}{3}  \text{ and the volume of the cone can be calculated as }  V = \frac{1}{3} \pi r^2 h. 
\text{(i) Show that the volume, }  V\,\text{cm}^3,  \text{ of water in the cone when the depth is }  x\,\text{cm}  \text{ can be}
\text{expressed as }  V = \frac{1}{9} \pi x^3.', 'LaTeX("Water is flowing into an empty right circular cone at a constant rate of  $8\\,$cm$^3$  per minute. The depth of the liquid in the cone at time,  $t,$  in minutes, is  $x\\,$cm$.$\nThe angle,  $\\alpha,$  between the perpendicular height,  $h,$  of the cone and the slant height is\n$\\tan^{-1} \\frac{\\sqrt{3}}{3}$  and the volume of the cone can be calculated as  $V = \\frac{1}{3} \\pi r^2 h.$\n(i) Show that the volume,  $V\\,$cm$^3,$  of water in the cone when the depth is  $x\\,$cm  can be\nexpressed as  $V = \\frac{1}{9} \\pi x^3.$").parsingMode(.onlyEquations)', 'LaTeX("Water is flowing into an empty right circular cone at a constant rate of  $8\\,$cm$^3$  per minute. The depth of the liquid in the cone at time,  $t,$  in minutes, is  $x\\,$cm$.$\nThe angle,  $\\alpha,$  between the perpendicular height,  $h,$  of the cone and the slant height is\n$\\tan^{(-1)} \\frac{\\sqrt{3}}{3}$  and the volume of the cone can be calculated as  $V = \\frac{1}{3} \\pi r^2 h.$\n(i) Show that the volume,  $V\\,$cm$^3,$  of water in the cone when the depth is  $x\\,$cm  can be\nexpressed as  $V = \\frac{1}{9} \\pi x^3.$").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 5
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2023, 'May', 3, 'b', 'i',
            '\text{Solve the equation }  2 \cos^2 x - 3 \sin x = 3  \text{ for }  0 < x < 2\pi .', '\text{Solve the equation }  2 \cos^2 x - 3 \sin x = 3  \text{ for }  0 < x < 2 \pi .', 'LaTeX("Solve the equation  $2 \\cos^2 x - 3 \\sin x = 3$  for  $0 < x < 2\\pi$.").parsingMode(.onlyEquations)', 'LaTeX("Solve the equation  $2 \\cos^2 x - 3 \\sin x = 3$  for  $0 < x < 2 \\pi$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 3
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2023, 'May', 5, 'a', 'i',
            '\text{Determine }  \lim_{x \rightarrow \infty} \frac{2x^3 - 4x + 1}{3x^4 + x^2 - 2} .', '\text{Determine }  \lim_{(x \rightarrow \infty)} \frac{2x^3 - 4x + 1}{3x^4 + x^2 - 2} .', 'LaTeX("Determine  $\\lim_{x \\rightarrow \\infty} \\frac{2x^3 - 4x + 1}{3x^4 + x^2 - 2}$.").parsingMode(.onlyEquations)', 'LaTeX("Determine  $\\lim_{(x \\rightarrow \\infty)} \\frac{2x^3 - 4x + 1}{3x^4 + x^2 - 2}$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 5
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2023, 'May', 6, 'b', 'i',
            '\text{The diagram below shows the curves }  y = \cos x  \text{ and }  y = \sin x . \text{ Determine the area bounded by the curves between }  x = \frac{\pi}{4}  \text{ and }  x = \frac{3\pi}{2} .', '\text{The diagram below shows the curves }  y = \cos x  \text{ and }  y = \sin x . \text{ Determine the area bounded by the curves between }  x = \frac{\pi}{4}  \text{ and }  x = \frac{3 \pi}{2} .', 'LaTeX("The diagram below shows the curves  $y = \\cos x$  and  $y = \\sin x$.  Determine the area bounded by the curves between  $x = \\frac{\\pi}{4}$  and  $x = \\frac{3\\pi}{2}$.").parsingMode(.onlyEquations)', 'LaTeX("The diagram below shows the curves  $y = \\cos x$  and  $y = \\sin x$.  Determine the area bounded by the curves between  $x = \\frac{\\pi}{4}$  and  $x = \\frac{3 \\pi}{2}$.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'PureMathematics U1' AND q.paper = 2 AND q.number = 6
          AND (2023 IS NULL OR q.year = 2023)
          AND q.part = 'b'
          AND q.subpart = 'i'
        LIMIT 1;
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2024, 'May', 6, 'c', 'ii',
            '\text{A car which has a mass of 1500 kg travels along a straight horizontal road at a constant speed of }  27 \, \text{ms}^{-1} \text{. The car then travels at a constant speed up a hill inclined at an angle }  \theta = \sin^{-1}(0.2) \text{. Determine the power of the engine if the speed of the car is }  15 \, \text{ms}^{-1}  \text{ and the resistance to motion is 600 N.}', '\text{A car which has a mass of 1500 kg travels along a straight horizontal road at a constant speed of }  27 \, \text{ms}^{-1} \text{. The car then travels at a constant speed up a hill inclined at an angle }  \theta = \sin^{(-1)}(0.2) \text{. Determine the power of the engine if the speed of the car is }  15 \, \text{ms}^{-1}  \text{ and the resistance to motion is 600 N.}', 'LaTeX("A car which has a mass of 1500 kg travels along a straight horizontal road at a constant speed of  $27 \\,$ms$^{-1}$. The car then travels at a constant speed up a hill inclined at an angle  $\\theta = \\sin^{-1}(0.2)$. Determine the power of the engine if the speed of the car is  $15 \\,$ms$^{-1}$  and the resistance to motion is 600 N.").parsingMode(.onlyEquations)', 'LaTeX("A car which has a mass of 1500 kg travels along a straight horizontal road at a constant speed of  $27 \\,$ms$^{-1}$. The car then travels at a constant speed up a hill inclined at an angle  $\\theta = \\sin^{(-1)}(0.2)$. Determine the power of the engine if the speed of the car is  $15 \\,$ms$^{-1}$  and the resistance to motion is 600 N.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'AppliedMathematics U1' AND q.paper = 2 AND q.number = 6
          AND (2024 IS NULL OR q.year = 2024)
          AND q.part = 'c'
          AND q.subpart = 'ii'
        LIMIT 1;
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2025, 'May', 6, 'c', 'i',
            '\text{Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is }  \sin^{-1}(\frac{1}{10}) \text{. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Calculate the work done to lift the 50 000 packages.}', '\text{Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is }  \sin^{(-1)}(\frac{1}{10}) \text{. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Calculate the work done to lift the 50 000 packages.}', 'LaTeX("Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is  $\\sin^{-1}(\\frac{1}{10})$. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Calculate the work done to lift the 50 000 packages.").parsingMode(.onlyEquations)', 'LaTeX("Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is  $\\sin^{(-1)}(\\frac{1}{10})$. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Calculate the work done to lift the 50 000 packages.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'AppliedMathematics U1' AND q.paper = 2 AND q.number = 6
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2025, 'May', 6, 'c', 'ii',
            '\text{Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is }  \sin^{-1}(\frac{1}{10}) \text{. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Calculate the power required to lift the packages.}', '\text{Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is }  \sin^{(-1)}(\frac{1}{10}) \text{. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Calculate the power required to lift the packages.}', 'LaTeX("Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is  $\\sin^{-1}(\\frac{1}{10})$. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Calculate the power required to lift the packages.").parsingMode(.onlyEquations)', 'LaTeX("Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is  $\\sin^{(-1)}(\\frac{1}{10})$. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Calculate the power required to lift the packages.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'AppliedMathematics U1' AND q.paper = 2 AND q.number = 6
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2025, 'May', 6, 'c', 'iii',
            '\text{Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is }  \sin^{-1}(\frac{1}{10}) \text{. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Hence, show that the total power output of the motor is 6687.5 W.}', '\text{Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is }  \sin^{(-1)}(\frac{1}{10}) \text{. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Hence, show that the total power output of the motor is 6687.5 W.}', 'LaTeX("Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is  $\\sin^{-1}(\\frac{1}{10})$. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Hence, show that the total power output of the motor is 6687.5 W.").parsingMode(.onlyEquations)', 'LaTeX("Every hour, a conveyor belt carries 50 000 packages 75 metres up a slope whose inclination is  $\\sin^{(-1)}(\\frac{1}{10})$. Each package weighs 45 N and the power absorbed by friction in driving the conveyor belt is 2000 W. Hence, show that the total power output of the motor is 6687.5 W.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'AppliedMathematics U1' AND q.paper = 2 AND q.number = 6
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 1, 'a', 'iv',
            '\text{Outline a suitable procedure for determining if a new snack in a school cafeteria, which is made from the legume chickpeas, contains starch and proteins. Your response MUST utilize all of the following apparatus and material:}
\text{1% copper sulfate solution}
\text{5% potassium hydroxide}
\text{Chickpea snack (in powder)}
\text{Distilled water}
\text{I}_2\text{/KI solution}
\text{Balance}
\text{Syringes (2 ml, 5 ml)}
\text{Test tubes}', '\text{Outline a suitable procedure for determining if a new snack in a school cafeteria, which is made from the legume chickpeas, contains starch and proteins. Your response MUST utilize all of the following apparatus and material:}
\text{1% copper sulfate solution}
\text{5% potassium hydroxide}
\text{Chickpea snack (in powder)}
\text{Distilled water}
...
\text{Balance}
\text{Syringes (2 ml, 5 ml)}
\text{Test tubes}', 'LaTeX("Outline a suitable procedure for determining if a new snack in a school cafeteria, which is made from the legume chickpeas, contains starch and proteins. Your response MUST utilize all of the following apparatus and material:\n1% copper sulfate solution\n5% potassium hydroxide\nChickpea snack (in powder)\nDistilled water\nI$_2$/KI solution\nBalance\nSyringes (2 ml, 5 ml)\nTest tubes").parsingMode(.onlyEquations)', 'LaTeX("Outline a suitable procedure for determining if a new snack in a school cafeteria, which is made from the legume chickpeas, contains starch and proteins. Your response MUST utilize all of the following apparatus and material:\n1% copper sulfate solution\n5% potassium hydroxide\nChickpea snack (in powder)\nDistilled water\nI$_2$/KI solution\nBalance\nSyringes (2 ml, 5 ml)\nTest tubes").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Biology U1' AND q.paper = 2 AND q.number = 1
          AND (2026 IS NULL OR q.year = 2026)
          AND q.part = 'a'
          AND q.subpart = 'iv'
        LIMIT 1;
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2024, 'May', 1, 'f', 'ii',
            '\text{Using the equation, }  2\,\text{MnO}_4^-(\text{aq}) + 5\,\text{NO}_2^-(\text{aq}) + 6\,\text{H}^+(\text{aq}) \rightarrow \text{Mn}^{2+}(\text{aq}) + 5\,\text{NO}_3^-(\text{aq}) + 3\,\text{H}_2\text{O}(\text{l}) 
\text{Deduce the number of moles of }  \text{KNO}_2  \text{ in the titre volume.}', '\text{Using the equation, }  2\,\text{MnO}_4^-(\text{aq}) + 5\,\text{NO}_2^-(\text{aq}) + 6\,\text{H}^+(\text{aq}) \rightarrow \text{Mn}^{2+}(\text{aq}) + 5\,\text{NO}_3^-(\text{aq}) + 3\,\text{H}_2 \text{O}(\text{l}) 
\text{Deduce the number of moles of }  \text{KNO}_2  \text{ in the titre volume.}', 'LaTeX("Using the equation,  $2\\,$MnO$_4^-($aq$) + 5\\,$NO$_2^-($aq$) + 6\\,$H$^+($aq$) \\rightarrow$Mn$^{2+}($aq$) + 5\\,$NO$_3^-($aq$) + 3\\,$H$_2$O$($l$)$\nDeduce the number of moles of  KNO$_2$  in the titre volume.").parsingMode(.onlyEquations)', 'LaTeX("Using the equation,  $2\\,$MnO$_4^-($aq$) + 5\\,$NO$_2^-($aq$) + 6\\,$H$^+($aq$) \\rightarrow$Mn$^{2+}($aq$) + 5\\,$NO$_3^-($aq$) + 3\\,$H$_2$O$($l$)$\nDeduce the number of moles of  KNO$_2$  in the titre volume.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2024, 'May', 2, 'd', 'i',
            '\text{Consider the following equilibrium reactions.}
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 1, 'h', 'i',
            '\text{Outline the experimental steps that can be used to determine the volume of a }  0.1152\,\text{M}  \text{ solution of }  \text{H}_2\text{SO}_4  \text{ which would be required to neutralize }  25.00\,\text{mL}  \text{ of a }  0.1913\,\text{M}  \text{ KOH solution.}', '\text{Outline the experimental steps that can be used to determine the volume of a }  0.1152\,\text{M}  \text{ solution of }  \text{H}_2 \text{SO}_4  \text{ which would be required to neutralize }  25.00\,\text{mL}  \text{ of a }  0.1913\,\text{M}  \text{ KOH solution.}', 'LaTeX("Outline the experimental steps that can be used to determine the volume of a  $0.1152\\,$M  solution of  H$_2$SO$_4$  which would be required to neutralize  $25.00\\,$mL  of a  $0.1913\\,$M  KOH solution.").parsingMode(.onlyEquations)', 'LaTeX("Outline the experimental steps that can be used to determine the volume of a  $0.1152\\,$M  solution of  H$_2$SO$_4$  which would be required to neutralize  $25.00\\,$mL  of a  $0.1913\\,$M  KOH solution.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 2 AND q.number = 1
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 2, 'b', 'i',
            '\text{Substance A and Substance B react according to the equation: }  \text{A} + 2\text{B} \rightarrow \text{AB}_2 . \text{ With reference to the experiment number used in Table 2, deduce the order of the reaction with respect to Substance A and Substance B.}', '\text{Substance A and Substance B react according to the equation: }  \text{A} + 2 \text{B} \rightarrow \text{AB}_2 . \text{ With reference to the experiment number used in Table 2, deduce the order of the reaction with respect to Substance A and Substance B.}', 'LaTeX("Substance A and Substance B react according to the equation:  A$+ 2$B$\\rightarrow$AB$_2$.  With reference to the experiment number used in Table 2, deduce the order of the reaction with respect to Substance A and Substance B.").parsingMode(.onlyEquations)', 'LaTeX("Substance A and Substance B react according to the equation:  A$+ 2$B$\\rightarrow$AB$_2$.  With reference to the experiment number used in Table 2, deduce the order of the reaction with respect to Substance A and Substance B.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U1' AND q.paper = 2 AND q.number = 2
...
\text{Define the term ‘structural isomerism’.}', 'LaTeX("A hydrocarbon compound whose molecular formula is  C$_8$H$_{18}$  was determined to have a given number of isomers.\nDefine the term ‘structural isomerism’.").parsingMode(.onlyEquations)', 'LaTeX("A hydrocarbon compound whose molecular formula is  C$_8$H$_{18}$  was determined to have a given number of isomers.\nDefine the term ‘structural isomerism’.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2025, 'May', 1, 'a', 'i',
            '\text{Figure 1 shows Compound A and Compound B which are two possible isomers of }  \text{C}_7\text{H}_{16} \text{.}
\text{Name EACH of the following compounds in Figure 1.}
\text{Compound A}
\text{Compound B}', '\text{Figure 1 shows Compound A and Compound B which are two possible isomers of }  \text{C}_7 \text{H}_{16} \text{.}
\text{Name EACH of the following compounds in Figure 1.}
\text{Compound A}
\text{Compound B}', 'LaTeX("Figure 1 shows Compound A and Compound B which are two possible isomers of  C$_7$H$_{16}$.\nName EACH of the following compounds in Figure 1.\nCompound A\nCompound B").parsingMode(.onlyEquations)', 'LaTeX("Figure 1 shows Compound A and Compound B which are two possible isomers of  C$_7$H$_{16}$.\nName EACH of the following compounds in Figure 1.\nCompound A\nCompound B").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 2 AND q.number = 1
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2025, 'May', 1, 'b', 'i',
            '\text{Another hydrocarbon, having molecular formula }  \text{C}_5\text{H}_{10}  \text{ undergoes oxidation reaction with hot acidified }  \text{KMnO}_4  \text{ to form two products, R and S. The products were subjected to analysis as seen in Table 1.}
\text{Complete Table 1 by inserting the appropriate observations and inferences in the spaces provided.}', '\text{Another hydrocarbon, having molecular formula }  \text{C}_5 \text{H}_{10}  \text{ undergoes oxidation reaction with hot acidified }  \text{KMnO}_4  \text{ to form two products, R and S. The products were subjected to analysis as seen in Table 1.}
\text{Complete Table 1 by inserting the appropriate observations and inferences in the spaces provided.}', 'LaTeX("Another hydrocarbon, having molecular formula  C$_5$H$_{10}$  undergoes oxidation reaction with hot acidified  KMnO$_4$  to form two products, R and S. The products were subjected to analysis as seen in Table 1.\nComplete Table 1 by inserting the appropriate observations and inferences in the spaces provided.").parsingMode(.onlyEquations)', 'LaTeX("Another hydrocarbon, having molecular formula  C$_5$H$_{10}$  undergoes oxidation reaction with hot acidified  KMnO$_4$  to form two products, R and S. The products were subjected to analysis as seen in Table 1.\nComplete Table 1 by inserting the appropriate observations and inferences in the spaces provided.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 2 AND q.number = 1
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2025, 'May', 1, 'b', 'iv',
            '\text{Name and draw the displayed structure of the hydrocarbon }  \text{C}_5\text{H}_{10}  \text{ that was oxidized.}', '\text{Name and draw the displayed structure of the hydrocarbon }  \text{C}_5 \text{H}_{10}  \text{ that was oxidized.}', 'LaTeX("Name and draw the displayed structure of the hydrocarbon  C$_5$H$_{10}$  that was oxidized.").parsingMode(.onlyEquations)', 'LaTeX("Name and draw the displayed structure of the hydrocarbon  C$_5$H$_{10}$  that was oxidized.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 2 AND q.number = 1
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2025, 'May', 2, 'h', 'i',
            '\text{Figure 4 shows a diagram of Compound D which has the molecular formula }  \text{C}_5\text{H}_8\text{O} \text{. Infrared spectroscopy was used to determine the structure of Compound D.}
\text{Compound D exhibits characteristic absorption wave numbers }  1695\,\text{cm}^{-1}  \text{ and }  1619\,\text{cm}^{-1}  \text{ in the infrared spectrum. Indicate the functional groups responsible for these absorptions.}', '\text{Figure 4 shows a diagram of Compound D which has the molecular formula }  \text{C}_5 \text{H}_8 \text{O} \text{. Infrared spectroscopy was used to determine the structure of Compound D.}
\text{Compound D exhibits characteristic absorption wave numbers }  1695\,\text{cm}^{-1}  \text{ and }  1619\,\text{cm}^{-1}  \text{ in the infrared spectrum. Indicate the functional groups responsible for these absorptions.}', 'LaTeX("Figure 4 shows a diagram of Compound D which has the molecular formula  C$_5$H$_8$O. Infrared spectroscopy was used to determine the structure of Compound D.\nCompound D exhibits characteristic absorption wave numbers  $1695\\,$cm$^{-1}$  and  $1619\\,$cm$^{-1}$  in the infrared spectrum. Indicate the functional groups responsible for these absorptions.").parsingMode(.onlyEquations)', 'LaTeX("Figure 4 shows a diagram of Compound D which has the molecular formula  C$_5$H$_8$O. Infrared spectroscopy was used to determine the structure of Compound D.\nCompound D exhibits characteristic absorption wave numbers  $1695\\,$cm$^{-1}$  and  $1619\\,$cm$^{-1}$  in the infrared spectrum. Indicate the functional groups responsible for these absorptions.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 1, 'b', 'ii',
            '\text{Compound A contains carbon, hydrogen and oxygen. Combustion analysis of }  0.544\,\text{g}  \text{ of Compound A gave }  1.039\,\text{g}  \text{ of }  \text{CO}_2  \text{ and }  0.637\,\text{g}  \text{ of }  \text{H}_2\text{O} \text{.}
\text{Calculate the empirical formula of Compound A.}', '\text{Compound A contains carbon, hydrogen and oxygen. Combustion analysis of }  0.544\,\text{g}  \text{ of Compound A gave }  1.039\,\text{g}  \text{ of }  \text{CO}_2  \text{ and }  0.637\,\text{g}  \text{ of }  \text{H}_2 \text{O} \text{.}
\text{Calculate the empirical formula of Compound A.}', 'LaTeX("Compound A contains carbon, hydrogen and oxygen. Combustion analysis of  $0.544\\,$g  of Compound A gave  $1.039\\,$g  of  CO$_2$  and  $0.637\\,$g  of  H$_2$O.\nCalculate the empirical formula of Compound A.").parsingMode(.onlyEquations)', 'LaTeX("Compound A contains carbon, hydrogen and oxygen. Combustion analysis of  $0.544\\,$g  of Compound A gave  $1.039\\,$g  of  CO$_2$  and  $0.637\\,$g  of  H$_2$O.\nCalculate the empirical formula of Compound A.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 2 AND q.number = 1
...
INSERT INTO fixed_questions (
            ...
            q.id, s.name, 2, 2026, 'May', 1, 'c', 'i',
            '\text{In the reaction scheme below, the primary amine, B, reacts with Reagent C.  \text{B} + \text{C} \rightarrow \text{CH}_3(\text{CH}_2)_4-\text{NH}_3\text{Cl} }
\text{State the name of the reagent C.}', '\text{In the reaction scheme below, the primary amine, B, reacts with Reagent C.  \text{B} + \text{C} \rightarrow \text{CH}_3(\text{CH}_2)_4-\text{NH}_3 \text{Cl} }
\text{State the name of the reagent C.}', 'LaTeX("In the reaction scheme below, the primary amine, B, reacts with Reagent C. \\( \\text{B} + \\text{C} \\rightarrow \\text{CH}_3(\\text{CH}_2)_4-\\text{NH}_3\\text{Cl} \\)\nState the name of the reagent C.").parsingMode(.onlyEquations)', 'LaTeX("In the reaction scheme below, the primary amine, B, reacts with Reagent C. \\( \\text{B} + \\text{C} \\rightarrow \\text{CH}_3(\\text{CH}_2)_4-\\text{NH}_3 \\text{Cl} \\)\nState the name of the reagent C.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 2 AND q.number = 1
...
INSERT INTO fixed_questions (
            ...
            '\text{Octane, }  \text{C}_8\text{H}_{18} \text{, can be cracked to form ethane and one other hydrocarbon. Write an equation to show this reaction.}', '\text{Octane, }  \text{C}_8 \text{H}_{18} \text{, can be cracked to form ethane and one other hydrocarbon. Write an equation to show this reaction.}', 'LaTeX("Octane,  C$_8$H$_{18}$, can be cracked to form ethane and one other hydrocarbon. Write an equation to show this reaction.").parsingMode(.onlyEquations)', 'LaTeX("Octane,  C$_8$H$_{18}$, can be cracked to form ethane and one other hydrocarbon. Write an equation to show this reaction.").parsingMode(.onlyEquations)',
            'latex_syntax_fix', 'pending'
        FROM questions q
        JOIN subjects s ON s.id = q.subject_id
        WHERE s.name = 'Chemistry U2' AND q.paper = 2 AND q.number = 3
          AND (2026 IS NULL OR q.year = 2026)
          AND q.part = 'a'
          AND q.subpart = 'ii'
        LIMIT 1;
