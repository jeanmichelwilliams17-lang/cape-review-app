...
function cleanAndRenderLatex(text) {
  ...
  // Auto-clean digit command collisions (4\sqrt -> 4 \sqrt), operator subscripts (\sum_{l=1} -> \sum_{(l=1)}, \lim_{x \to 3} -> \lim_{(x \to 3)}), and unbracketed trig inverse powers (\cos^{-1} -> \cos^{(-1)})
